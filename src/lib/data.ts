...
export const UFT_DATA: UFTData = {
  ...
  services: [
    ...
    },
    {
      ...
      descFull: "We build, modernize, and scale software products for enterprises across BFSI, retail, and healthcare — from core banking and insurance platforms to omnichannel retail systems and clinical applications. Our cross-functional engineering teams cover the full delivery spectrum — from new product builds and platform modernization to migrating legacy systems into scalable, cloud-ready architectures. We provide end-to-end capability across all phases of the software lifecycle, giving clients a single accountable partner from inception through to production.",
  ...
  team: [
    ...
    },
    {
      ...
      photo: "/assets/team-gayathri-3.png",
      photoPosition: "50% 40%",
